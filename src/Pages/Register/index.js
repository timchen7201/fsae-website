    ...
    return (
        <div className="container">
            <div className="mt-5">
                        ...
                        <Card>
                            ...
                            <Accordion.Collapse eventKey="1">
                                <Card.Body>
                                    <ul>
                                        <li>
                                            <a href="../assets/files/tblFasteners_2021_FST_v1.xlsx">tblFasteners_2021_FST_v1</a>
                                        </li>
                                        <li>
                                            <a href="../assets/files/tblMaterials_2021_FST_v1.xlsx">tblMaterials_2021_FST_v1</a>
                                        </li>
                                        <li>
                                            <a href="../assets/files/tblProcesses_2021_FST_v1.xlsx">tblProcesses_2021_FST_v1</a>
                                        </li>
                                        <li>
                                            <a href="../assets/files/tblProcessMultipliers_2021_FST_v1.xlsx">tblProcessMultipliers-2021_FST_v1</a>
                                        </li>
                                        <li>
                                            <a href="../assets/files/tblTooling_2021_FST_v1.xlsx">tblTooling_2021_FST_v1</a>
                                        </li>
                                        <li>
                                            <a href="../assets/files/FST_FCA_Template_2021.xlsx">FST_FCA_Template_2021</a>
                                        </li>
                                        <li>
                                            <a href="../assets/files/FST_BOM_Template_2021.xlsx">FST_BOM_Template_2021</a>
                                        </li>
                                        <li>
                        ...
                        <Card>
                            ...
                            <Accordion.Collapse eventKey="2">
                                <Card.Body>
                                    <ul>
                                        <li>
                                            <a href="../assets/files/No1_Energy_Meter_Specification.pdf">No.1_【For_EV_Only】Energy_Meter_Specification</a>
                                        </li>
                                        <li>
                                            <a href="../assets/files/EnergyMeterSLDPRT">Energy Meter.SLDPRT</a>
                                        </li>
                                    </ul>
                                </Card.Body>
                            </Accordion.Collapse>
                            ...
                            <Accordion.Collapse eventKey="4">
                                <Card.Body>
                                    <ul>
                                        ...
                                        <li>
                                            <a href="../assets/files/2021 Taiwan Student Formula_participation rule.pdf">2021 Taiwan Student Formula_participation rule</a>
                                        </li>
                                    </ul>
                                </Card.Body>
                            </Accordion.Collapse>
                        ...
                        <Card>
                            ...
                            <Accordion.Collapse eventKey="5">
                                <Card.Body>
                                    <ul>
                                        <li>
                                            <a href="../assets/files/2021_FST_business plan presentation.docx">2021_FST_business plan presentation</a>
                                        </li>
                                        <li>
                            ...
                            <Accordion.Collapse eventKey="11">
                                <Card.Body>
                                    <ul>
                                        <li>
                                            <a
                                                href="../assets/files/2021_FST_Structrual_Equivalency_Spreadsheet_Steel_Tube_v1.xlsx">2021_FST_Structrual_Equivalency-Spreadsheet_Steel_Tube_v1</a>
                                        </li>
                                    </ul>
                                </Card.Body>
                            </Accordion.Collapse>
                ...
                <div className="">
                    <h2>繳交辦法</h2>
                    <p>請繳交切結書給相關人員後， 我們會給予一組帳號密碼，到時候再登入後會看到有上角會顯示您的車號，點擊後可以看到上傳資料的選項"</p>
